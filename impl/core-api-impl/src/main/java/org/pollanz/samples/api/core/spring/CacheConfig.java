...
public class CacheConfig {
    ...
    public HazelcastInstance hazelcastInstance() {
        ...
        if (environment.getProperty("sample.core.cache.localNetwork.enabled", Boolean.class, Boolean.FALSE)) {
...
//        config.getMapConfigs().put("org.pollanz.samples.api.core.domain.*", initializeDomainMapConfig());
    ...
    private ManagementCenterConfig initializeDefaultManagementCenterConfig() {
        ...
        managementCenterConfig.setEnabled(environment.getProperty("sample.core.cache.managementCenterConfig.enabled", Boolean.class, Boolean.FALSE));
        managementCenterConfig.setUrl(environment.getProperty("sample.core.cache.managementCenterConfig.url", StringUtils.EMPTY));
