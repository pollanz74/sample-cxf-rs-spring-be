...
public class CacheConfig {
    ...
    public HazelcastInstance hazelcastInstance() {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("sample-cxf-rs-spring-be");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("sample-cxf-rs-spring-be");
     ...
     */
        ...
        mapConfig.setTimeToLiveSeconds(environment.getProperty("sample_gateway_cache_defaul_timeToLiveSeconds", Integer.class, 60));
